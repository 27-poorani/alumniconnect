...
function AdminDashboard() {
  ...
  const fetchAlumni = async () => {
    ...
    try {
      ...
      const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/admin/alumni', {
  ...
  const fetchTopStudents = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/admin/top-students', {
        headers: { 'x-auth-token': token },
      });
      const data = await res.json();
  ...
  const fetchHighlights = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/admin/placement-highlights', {
        headers: { 'x-auth-token': token },
      });
      const data = await res.json();
  ...
  const fetchAlumniPosts = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/admin/posts', {
        headers: { 'x-auth-token': token },
      });
      const data = await res.json();
  ...
  const handleApprovePost = async (id, approved) => {
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/posts/${id}/approve`, {
        method: 'PATCH',
  ...
  const handleRemoveAttachment = async (post) => {
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/posts/${post._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
  ...
  const handleDeletePost = async (id) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/posts/${id}`, {
        method: 'DELETE',
        headers: { 'x-auth-token': token },
      });
      const data = await res.json();
  ...
  const fetchEvents = async () => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/admin/events', {
        headers: { 'x-auth-token': token },
      });
      const data = await res.json();
  ...
  const handleEventFormSubmit = async (e) => {
    ...
    try {
      ...
      const url = editEventId ? `${process.env.REACT_APP_BACKEND_URL}/api/admin/events/${editEventId}` : '${process.env.REACT_APP_BACKEND_URL}/api/admin/events';
  ...
  const handleDeleteEvent = async (id) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/events/${id}`, {
        method: 'DELETE',
        headers: { 'x-auth-token': token },
      });
      const data = await res.json();
  ...
  const handleDeleteStudent = async (id) => {
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/top-students/${id}`, {
        method: 'DELETE',
        headers: { 'x-auth-token': token },
      });
  ...
  const handleStudentFormSave = async (e) => {
    ...
    try {
      ...
      if (addMode) {
        ...
        const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/top-students/${editStudent._id}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json', 'x-auth-token': token },
          body: JSON.stringify(studentForm),
        });
  ...
  const handleDeleteConfirm = async () => {
    try {
      const token = localStorage.getItem('token');
      const res = await fetch(`${process.env.REACT_APP_BACKEND_URL}/api/admin/alumni/${deleteId}`, {
        method: 'DELETE',
        headers: { 'x-auth-token': token },
      });
  ...
  const handlePhotoChange = async (e) => {
    ...
    try {
      ...
      const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/admin/top-students/upload-photo', {
        method: 'POST',
        headers: { 'x-auth-token': token },
        body: formData,
      });
      ...
      setStudentForm((prev) => ({ ...prev, photo: `${process.env.REACT_APP_BACKEND_URL}${data.url}` }));
    } catch (err) {
      setErrorTop(err.message);
    }
