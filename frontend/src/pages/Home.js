...
function Home() {
  ...
  useEffect(() => {
    const fetchTopStudents = async () => {
      ...
      setError('');
      try {
        const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/top-students');
  ...
  useEffect(() => {
    const fetchHighlights = async () => {
      ...
      setErrorHighlights('');
      try {
        const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/placement-highlights');
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchAlumniPosts = async () => {
      ...
      setErrorPosts('');
      try {
        const res = await fetch('${process.env.REACT_APP_BACKEND_URL}/api/alumni/posts');
        const data = await res.json();
