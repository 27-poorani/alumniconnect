// API Configuration
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://alumniconnect-ytt.onrender.com';
...
export const API_ENDPOINTS = {
  ...
  ALUMNI_UPLOAD_PHOTO: `${API_BASE_URL}/api/alumni/upload-photo`,
  ALUMNI_POST_UPLOAD_ATTACHMENT: `${API_BASE_URL}/api/alumni/post/upload-attachment`,
  ...
  ADMIN_ALUMNI_POSTS: `${API_BASE_URL}/api/admin/alumni-posts`,
  ADMIN_EVENTS: `${API_BASE_URL}/api/admin/events`,
  ADMIN_TOP_STUDENTS_UPLOAD_PHOTO: `${API_BASE_URL}/api/admin/top-students/upload-photo`,
